...
> **Sample on GitHub** · `GER30_1m.csv` (55,440 rows, `2026-06-26` -> `2026-09-02`, 5.21 MB). **Full archive on [getdata.finance](https://getdata.finance/datasets/ger30)** — **2,331,838** `1m` rows, **11 timeframes**, `2019-01-02` -> `2026-09-02`.
